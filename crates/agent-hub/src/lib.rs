...
use agent_protocol::{ErrorResponse, MessageRecord};
...
mod tests {
    ...
    async fn register_is_idempotent_and_status_can_update() {
        ...
        let response = app
            ...
            .await
            .unwrap();
        let agent: agent_protocol::AgentRecord = decode(response).await;
    ...
    async fn task_file_claim_and_finding_flows_work() {
        ...
        let claim_response = app
            ...
            .await
            .unwrap();
        let claim: agent_protocol::FileClaimResponse = decode(claim_response).await;
        ...
        let second_claim_response = app
            ...
            .await
            .unwrap();
        let second_claim: agent_protocol::FileClaimResponse = decode(second_claim_response).await;
        ...
        let finding_response = app
            ...
            .await
            .unwrap();
        let finding: agent_protocol::FindingRecord = decode(finding_response).await;
        assert_eq!(finding.kind, FindingKind::RootCause);

        let findings: Vec<agent_protocol::FindingRecord> = decode(
...
"#;
        ...
        let events: Vec<agent_protocol::PipelineEventRecord> = decode(
            app.clone()
    ...
    async fn stream_replay_uses_last_event_id() {
        ...
        use agent_protocol::MessageCreateRequest;
